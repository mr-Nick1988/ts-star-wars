...
const Contact = ({ hero, planets }: WithErrorPageProps) => {
    return hero ? (
        <form className="w-4/5 my-0 mx-auto rounded-[5px] bg-[#f2f2f2] p-5" onSubmit={(e) => e.preventDefault()}>
            <label className="w-full text-red-color">
                First Name
                <input
                    className="border w-full p-3 border-[#ccc] rounded-[4px] mt-1.5 mb-4 resize-y"
                    type="text"
                    name="firstname"
            ...
            <label className="w-full text-red-color">
                Subject
                <textarea
                    className="border h-52 w-full p-3 border-[#ccc] rounded-[4px] mt-1.5 mb-4 resize-y"
                    name="subject"
